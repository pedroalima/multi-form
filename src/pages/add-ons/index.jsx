...
function AddOns() {
    return (
        <section className="bg-white p-4 mb-5 mb-md-0 p-md-5" id="add-ons">
            ...
            <form className='px-md-5 d-md-flex justify-content-md-between'>
                ...
                <label htmlFor="service" className="card flex-row align-items-center p-3 border-custom flex-md-column text-left width-custom">
                    <BsCheckSquareFill />
                ...
                <label htmlFor="storage" className="card flex-row align-items-center p-3 border-custom flex-md-column text-left width-custom">
                    <BsCheckSquareFill />
                    <div className="card-body p-0 ml-3 ml-md-0">
                ...
                <label htmlFor="profile" className="card flex-row align-items-center p-3 border-custom flex-md-column text-left width-custom">
                    <BsCheckSquareFill />
                    <div className="card-body p-0 ml-3 ml-md-0">
