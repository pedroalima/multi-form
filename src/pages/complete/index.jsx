...
function Complete() {
    ...
    return (
        <section className="bg-white px-4 h-100 d-flex justify-content-center text-center" id="complete">
            <div className="jumbotron jumbotron-fluid bg-transparent my-auto mx-0">
                <div className="container">
                    <img src={iconThanks} alt="Thank you icon" />
                    <h1 className="display-5 font-tertiary-color pt-2">Thank you!</h1>
